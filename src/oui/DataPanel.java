...
public class DataPanel extends JPanel implements ActionListener {
	...
	private void initComponents() {
		...
		btnCreate.addActionListener(this);   //------> imp
...
//////////IGNORE/////
	...
	// add action listner
	//Jab Jab button is clicked action performed is fired
	@Override
	public void actionPerformed(ActionEvent e) {
		...
		Thread t = new Thread(new Runnable() {
			...
			public void run() {
				try {
					int rows = Integer.parseInt(txtRows.getText()); // rows store the number of rows to be created
